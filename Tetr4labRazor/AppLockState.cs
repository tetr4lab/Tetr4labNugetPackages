...
public class AppLockState : IAppLockState, INotifyPropertyChanged {
    ...
    /// <summary>目標値</summary>
    public virtual int TotalProgressValue {
        get => _totalProgress;
        protected set {
    ...
    /// <summary>現在値</summary>
    public virtual int CurrentProgressValue {
    ...
    /// <param name="reason">ロックの理由</param>
    /// <param name="totalProgressValue">進捗の完了目標値</param>
    public virtual void Lock (string reason, int totalProgressValue) {
        IsLocked = true;
        Reason = reason;
    ...
    /// <summary>ロック状態にする</summary>
    /// <param name="totalProgressValue">進捗の完了目標値</param>
    public virtual void Lock (int totalProgressValue) {
        IsLocked = true;
        Reason = string.Empty;
        TotalProgressValue = totalProgressValue < 0 ? 0 : totalProgressValue;
        CurrentProgressValue = 0;
    ...
    /// <summary>進捗率</summary>
    public virtual double ProgressPercentage => 100d * CurrentProgressValue / TotalProgressValue;
}
